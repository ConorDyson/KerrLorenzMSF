...
(*Save path*)
savepath ="/Users/conordyson/Documents/Research/Open/Gravitational-SF/h1Solvers/KerrLorenzMSF/Radiative/Radiative-Cluster/Numerics-Asymptotics/h1-mmode-gen/h1mmodedat";
(*Parameters*)
a=6/10;
r0=8;
mmax=6;
...
rhor=(rp/.{rprmvals}) + 1/10^4;
rmin=rhor;


{rgridL,rgridR}=MetricReconstructRadiative`Private`BuildGrid[a,{r0,rmin,rmax},{WorkingPrecision->prec,"nterms"-> nterms, 
"kapord"->kapord, 
"rinf"->rinf, 
"rmax"->rmax,"xhor"->xhor,"inford"->inford, 
"horord"->horord, 
AccuracyGoal->accgoal,
"rgrid"->0, 
"rstmin"->rstmin,
"rstmax"->rstmax,"nres"->n,
"angres"->angres }];
