...
MetricReconstructRadiative[iConfig_,primarypath_,"old"]:=Module[{r,\[Lambda],l,\[CapitalOmega]0},
Print["old"];
...
teuks2subs2=DefTeukSubs[2,{Pm2,Pp2,Sm2,Sp2},{\[CapitalDelta],K},{M,a,m,\[Omega],\[CapitalLambda]},{r,\[Theta]}];
Print[teuks2subs==teuks2subs2];
...
{a0,r0,mm,lmax,lplot,nterms}//Print;
...
{\[Kappa]ord,rinf,rmin,rmax,xhor,inford,horord,accgoal,rstarmin,rstarmax,nres,qres}//Print;
...
EchoTiming[GetSsubs[20,SetPrecision[\[Pi]/4,prec]]];
...
EchoTiming[GetS0subs[SetPrecision[\[Pi]/4,prec],2]];
...
EchoTiming[Get\[Kappa]subs[2,SetPrecision[3.7,prec]];];
...
EchoTiming[GetAll\[Kappa]subs[SetPrecision[3.7,prec]];];
...
rtry=SetPrecision[7.1,prec];
EchoTiming[tmp1=Calcs2components[rtry];];
EchoTiming[
