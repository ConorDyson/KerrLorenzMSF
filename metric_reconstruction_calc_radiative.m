...
(EFluxInf-mode["Fluxes"]["Energy"]["\[ScriptCapitalI]"])//N (* The difference in fluxes from the two methods. *)
...
sourcetermsubs0=sourcetermsubs=Table[Simplify[{dhlplp[ll]->-16*\[Pi]/(\[CapitalDelta][r]*ut)*calA^2*SpinWeightedSphericalHarmonicY[0,ll,mm,\[Pi]/2,0],
dhlmlm[ll]->-16*\[Pi]/(\[CapitalDelta][r]*ut)*calA^2*SpinWeightedSphericalHarmonicY[0,ll,mm,\[Pi]/2,0]}/.ABDsubs]/.\[CapitalDelta]Kr0subs/.{r->r0,a->a0}/.orbitsubs,
{ll,lmins0,lmax}]//Flatten;
sourcetermsubs1=Table[Simplify[{d\[Rho]chlpmm[ll]->-16*\[Pi]/(\[CapitalDelta][r]*ut)*(r*I*calA*calB)*SpinWeightedSphericalHarmonicY[-1,ll,mm,\[Pi]/2,0]}/.ABDsubs]/.\[CapitalDelta]Kr0subs/.{r->r0,a->a0}/.orbitsubs,
{ll,lmins1,lmax}]//Flatten;
sourcetermsubs2=Table[Simplify[{dhmpmp[ll]->16*\[Pi]/(\[CapitalDelta][r]*ut)*calB^2*SpinWeightedSphericalHarmonicY[2,ll,mm,\[Pi]/2,0],
dhmmmm[ll]->16*\[Pi]/(\[CapitalDelta][r]*ut)*calB^2*SpinWeightedSphericalHarmonicY[-2,ll,mm,\[Pi]/2,0]}/.ABDsubs]/.\[CapitalDelta]Kr0subs/.{r->r0,a->a0}/.orbitsubs,
...
\[Rho]hj0lpmp/.s2jumps/.s0jumps/.knowns//Simplify//Abs
\[Rho]chj0lpmm/.s2jumps/.s0jumps/.knowns//Simplify//Abs
(*
If[mm==1,
