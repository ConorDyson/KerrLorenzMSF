...
#SBATCH --output=/groups/astro/dyson/Open/KerrLorenzMSF/Ret-Numerics/h1-radial-gen/logsAsymptotic/task_%a.txt
#SBATCH --error=/groups/astro/dyson/Open/KerrLorenzMSF/Ret-Numerics/h1-radial-gen/logsAsymptotic/task_%a.txt

PAIRS_FILE="/groups/astro/dyson/Open/KerrLorenzMSF/Ret-Numerics/h1-radial-gen/logsAsymptotic/pairs.txt"
SCRIPT_DIR="/groups/astro/dyson/Open/KerrLorenzMSF/Ret-Numerics/h1-radial-gen"
SAVEPATH="/lustre/astro/dyson/DataFiles/KerrCircSourceFiles/h1RadialAsymptotic"
...
LOG="${SCRIPT_DIR}/logsAsymptotic/h1_a${a}_r${r0}.log"
exec > "$LOG" 2>&1
