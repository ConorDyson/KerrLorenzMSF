...
#SBATCH --output=/groups/astro/dyson/Open/KerrLorenzMSF/Ret-Numerics/h1-radial-gen/logsAsymp/task_%a.txt
#SBATCH --error=/groups/astro/dyson/Open/KerrLorenzMSF/Ret-Numerics/h1-radial-gen/logsAsymp/task_%a.txt

PAIRS_FILE="/groups/astro/dyson/Open/KerrLorenzMSF/Ret-Numerics/h1-radial-gen/logsAsymp/pairs.txt"
SCRIPT_DIR="/groups/astro/dyson/Open/KerrLorenzMSF/Ret-Numerics/h1-radial-gen"
SAVEPATH="/lustre/astro/dyson/DataFiles/KerrCircSourceFiles/h1RadialAsymp"
...
LOG="${SCRIPT_DIR}/logsAsymp/h1_a${a}_r${r0}.log"
exec > "$LOG" 2>&1
