...
#SBATCH --output=/groups/astro/dyson/Open/KerrLorenzMSF/Numerics-WorldTube/h1-radial-gen/logs/task_%a.txt
#SBATCH --error=/groups/astro/dyson/Open/KerrLorenzMSF/Numerics-WorldTube/h1-radial-gen/logs/task_%a.txt

PAIRS_FILE="/groups/astro/dyson/Open/KerrLorenzMSF/Numerics-WorldTube/h1-radial-gen/logs/pairs.txt"
SCRIPT_DIR="/groups/astro/dyson/Open/KerrLorenzMSF/Numerics-WorldTube/h1-radial-gen"
SAVEPATH="/lustre/astro/dyson/DataFiles/KerrCircSourceFiles/h1Radial"
